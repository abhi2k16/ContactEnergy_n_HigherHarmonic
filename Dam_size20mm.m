%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\CPRESS_all_node_dam20mm150kHz-2.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\U2CPP_+126_-113_dam20mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\U2CSP_-126_+113_dam20mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\U2SEN_1-3_-1_dam20mm150kHz.xlsx');
%% Extraction of CPRESS_-126_+113_dam20mm150kHz i.e cpress
x_cpress =zeros(1001,19*102);
for i=1:19
    for j=1:102
...
for i=1:19
 ...
 X_CPP =zeros(1001,267);
 X_CPP(:,1) = x_cpp(:,1);
for i=1:19
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp(:,(19-i)*14+1+j);
    end
end
...
I_Section_ENR=sum(sum(ENR_MAT(1:19,12:16)))
