%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\CPRESS_all_node_dam14mm120kHz.xlsx');
x_cpp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\U2CPP_+84_-71_dam14mm120kHz.rpt');
x_csp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\U2CSP_-84_+71_dam14mm120kHz.rpt');
%% Extraction of CPRESS_-84_+71_dam10mm180kHz i.e cpress
x_cpress =zeros(1001,13*102);
for i=1:13
    for j=1:102
...
for i=1:13
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp.data(:,(13-i)*14+1+j);
    end
end
...
I_Section_ENR=sum(sum(ENR_MAT(1:13,12:16)))
