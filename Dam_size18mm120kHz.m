%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size18mm\CPRESS_all_node_dam18mm120kHz.xlsx');
x_cpp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size18mm\U2CPP_+112_-99_dam18mm120kHz.rpt');
x_csp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size18mm\U2CSP_-112_+99_dam18mm120kHz.rpt');
...
for i=1:17
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp.data(:,(17-i)*14+1+j);
    end
end
