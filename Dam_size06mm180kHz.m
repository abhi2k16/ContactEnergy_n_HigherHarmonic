%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\CPRESS_all_node_dam06mm180kHz.xlsx');
x_cpp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\U2CPP_+28_-15_dam06mm180kHz.rpt');
x_csp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\U2CSP_-28_+15_dam06mm180kHz.rpt');
%% Extraction of CPRESS_-28_+15_dam20mm180kHz i.e cpress
x_cpress =zeros(1001,5*102);
for i=1:5
    for j=1:102
...
for i=1:5
 ...
 X_CPP(:,2:15) = x_cpp.data(:,58:71);
 X_CPP(:,16:29) = x_cpp.data(:,44:57);
 X_CPP(:,30:43) = x_cpp.data(:,30:43);
 X_CPP(:,44:57) = x_cpp.data(:,16:29);
 X_CPP(:,58:71) = x_cpp.data(:,2:15);
