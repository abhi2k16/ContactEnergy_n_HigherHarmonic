%%
clear; clear all;
x_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size04mm\CPRESS_-14_+1_dam04mm150kHz.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size04mm\U2CPP_+14_-1_dam04mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size04mm\U2CSP_-14_+1_dam04mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size04mm\U2SEN_1-3_-1_dam04mm150kHz.xlsx');
...
for i=1:3
 ...
 X_CPP =zeros(2001,43);
  X_CPP(:,1) = x_cpp(:,1);
 X_CPP(:,2:15) = x_cpp(:,30:43);
 X_CPP(:,16:29) = x_cpp(:,16:29);
 X_CPP(:,30:43) = x_cpp(:,2:15);
...
I_Section_ENR=sum(sum(ENR_MAT(1:3,12:16)))
