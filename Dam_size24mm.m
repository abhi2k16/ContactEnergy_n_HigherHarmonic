%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size24mm\CPRESS_all_node_dam24mm150kHz.xlsx');
x_cpp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size24mm\U2CPP_-154_-140__+127_+141_dam24mm150kHz.rpt');
x_csp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size24mm\U2CSP_-154_+141_dam24mm150kHz.rpt');
%%
% Extraction of CPRESS_-126_+113_dam20mm150kHz i.e cpress
x_cpress =zeros(1001,23*102);
for i=1:23
    for j=1:101
        x_cpress(:,(i-1)*101+j)=x_all_node_cpress(:,67+(i-1)*107+j);
    end
end
%%
% CPRESS extraction and arrangment
X_CPRESS=zeros(1001,322);
...
X_CPRESS(:,211)=x_cpress(:,1531);
X_CPRESS(:,225)=x_cpress(:,1633);
X_CPRESS(:,239)=x_cpress(:,1735);
X_CPRESS(:,253)=x_cpress(:,1837);
X_CPRESS(:,267)=x_cpress(:,1939);
X_CPRESS(:,281)=x_cpress(:,2041);
X_CPRESS(:,295)=x_cpress(:,2143);
X_CPRESS(:,309)=x_cpress(:,2245);
for i=1:23
    for j=1:13
 ...
 %%
 % x_cpp column arrangment [U2CPP_-154_+127_dam24mm150kHz]
 X_CPP =zeros(1001,323);
 X_CPP(:,1) = x_cpp.data(:,1);
for i=1:23
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp.data(:,(j-1)*23+i+1);
    end
end
 %%
...
%// Define z values
p=1;
c_p1 = p+1;c_p2 = p+29;c_p3 =p+57;c_p4 = p+85;c_p5 = p+113; c_p6 =p+141; c_p7 =p+ 169; c_p8 = p+197; % contact position
c_p9 = 225+1; c_p10 = 253+1;
...
zMat1 =[zSCP1 zSCP2 zSCP3 zSCP4 zSCP5 zSCP6 zSCP7 zSCP8 zSCP9 zSCP10];
zSCS1 = x_csp.data(2:end,c_p1);
zSCS2 = x_csp.data(2:end,c_p2);
zSCS3 = x_csp.data(2:end,c_p3);
zSCS4 = x_csp.data(2:end,c_p4);
zSCS5 = x_csp.data(2:end,c_p5);
zSCS6 = x_csp.data(2:end,c_p6);
zSCS7 = x_csp.data(2:end,c_p7);
zSCS8 = x_csp.data(2:end,c_p8);
zSCS9 = x_csp.data(2:end,c_p9);
zSCS10 = x_csp.data(2:end,c_p10);
zMat2 =[zSCS1 zSCS2 zSCS3 zSCS4 zSCS5 zSCS6 zSCS7 zSCS8 zSCS9 zSCS10];   %// For plot3
figure
