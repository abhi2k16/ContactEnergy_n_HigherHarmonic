%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size22mm\CPRESS_all_node_dam22mm150kHz.xlsx');
x_cpp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size22mm\U2CPP_+140_-127_dam22mm150kHz.rpt');
x_csp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size22mm\U2CSP_-140_+127_dam22mm150kHz.rpt');
%%
% Extraction of CPRESS_-126_+113_dam20mm150kHz i.e cpress
x_cpress =zeros(1001,21*102);
for i=1:21
    for j=1:101
...
for i=1:21
 ...
 X_CPP =zeros(1001,295);
 X_CPP(:,1) = x_cpp.data(:,1);
for i=1:21
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp.data(:,(21-i)*14+1+j);
    end
end
 %%
...
c_p9 = p+112*2; c_p10 = p+126*2;c_p11 = p+140*2;
