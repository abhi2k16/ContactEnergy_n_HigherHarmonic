%%
clear; clear all;
x_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\CPRESS_-84_+71_dam14mm150kHz.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\U2CPP_+84_-71_dam14mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\U2CSP_-84_+71_dam14mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size14mm\U2SEN_1-3_-1_dam14mm150kHz.xlsx');
%%
% CPRESS extraction and arrangment
X_CPRESS=zeros(1001,182);
...
%% x_cpp column arrangment
 X_CPP =zeros(1001,183);
 X_CPP(:,1) = x_cpp(:,1);
for i=1:13
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp(:,(13-i)*14+1+j);
    end
end
...
I_Section_ENR=sum(sum(ENR_MAT(1:13,11:17)))
...
%// Define z values
p=14;
c_p1 = p+1;c_p2 = p+14*2;c_p3 =p+28*2;c_p4 = p+42*2;c_p5 = p+56*2; c_p6 =p+70*2; c_p7 =p+ 84*2; c_p8 = p+98; % contact position
