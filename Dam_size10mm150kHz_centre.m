%%
clear; clear all;
x_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size10mm\CPRESS_-56_+43_dam10mm150kHz.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size10mm\U2CPP_-43_+56_dam10mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size10mm\U2CSP_-56_+43_dam10mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size10mm\U2SEN_1-3_-1_dam10mm150kHz.xlsx');
%%
...
figure;surf(ENR_Matrix(:,7:14));shading interp
...
figure;surf(ENR_MAT(:,7:20));shading interp
%% summation of energy
