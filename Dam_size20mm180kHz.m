%%
clear; clear all;
x_all_node_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\CPRESS_all_node_dam20mm180kHz.xlsx');
x_cpp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\U2CPP_+126_-113_dam20mm180kHz.rpt');
x_csp=importdata('C:\Users\abhij\Desktop\WaveModel\Dam_size20mm\U2CSP_-126_+113_dam20mm180kHz.rpt');
...
for i=1:19
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp.data(:,(19-i)*14+1+j);
    end
end
