%%
clear; clear all;
x_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size08mm\CPRESS_-42_+29_dam08mm150kHz.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size08mm\U2CPP_+42_-29_dam08mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size08mm\U2CSP_-42_+29_dam08mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size08mm\U2SEN_1-3_-1_dam08mm150kHz.xlsx');
%%
...
for i=1:7
 ...
 X_CPP =zeros(1001,99);
 X_CPP(:,1) = x_cpp(:,1);
 X_CPP(:,2:15) = x_cpp(:,86:99);
 X_CPP(:,16:29) = x_cpp(:,72:85);
 X_CPP(:,30:43) = x_cpp(:,58:71);
 X_CPP(:,44:57) = x_cpp(:,44:57);
 X_CPP(:,58:71) = x_cpp(:,30:43);
 X_CPP(:,72:85) = x_cpp(:,16:29);
 X_CPP(:,86:99) = x_cpp(:,2:15);
 %%
