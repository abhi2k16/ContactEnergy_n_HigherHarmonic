%%
clear; clear all;
x_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size16mm\CPRESS_-98_+85_dam16mm150kHz.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size16mm\U2CPP_+98_-85_dam16mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size16mm\U2CSP_-98_+85_dam16mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size16mm\U2SEN_1-3_-1_dam16mm150kHz.xlsx');
...
for i=1:15
    for j= 1:14
        X_CPP(:,(i-1)*14+j+1)=x_cpp(:,(15-i)*14+1+j);
    end
end
...
I_Section_ENR=sum(sum(ENR_MAT(1:15,12:16)))
