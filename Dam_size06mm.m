%%
clear; clear all;
x_cpress=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\CPRESS_-28_+15_dam06mm150kHz.xlsx');
x_cpp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\U2CPP_+28_-15_dam06mm150kHz.xlsx');
x_csp=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\U2CSP_-28_+15_dam06mm150kHz.xlsx');
x_sen=xlsread('C:\Users\abhij\Desktop\WaveModel\Dam_size06mm\U2SEN_1-3_-1_dam06mm150kHz.xlsx');
%%
% CPRESS extraction and arrangment
X_CPRESS=zeros(1001,70);
...
for i=1:5
 ...
 X_CPP =zeros(1001,71);
 X_CPP(:,1) = x_cpp(:,1);
 X_CPP(:,2:15) = x_cpp(:,58:71);
 X_CPP(:,16:29) = x_cpp(:,44:57);
 X_CPP(:,30:43) = x_cpp(:,30:43);
 X_CPP(:,44:57) = x_cpp(:,16:29);
 X_CPP(:,58:71) = x_cpp(:,2:15);
 %%
...
I_Section_ENR=sum(sum(ENR_MAT(1:5,12:16)));
...
figure;surf(CPRESS_MAT);shading interp%% Plotting transverse displacement
%// Define the x values
t=x_csp(2:end,1).*1000000;
tMat = repmat(t,1,5); %// For plot3
%// Define y values
y = 1:1:5;
yMat = repmat(y, numel(t), 1); %//For plot3
%// Define z values
p=14;
c_p1 = p+1;c_p2 = p+14;c_p3 =p+28;c_p4 = p+42;c_p5 = p+56; c_p6 =p+70*2; c_p7 =p+ 84*2; c_p8 = p+98*2; % contact position
